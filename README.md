...
A wider sweep of 341 wild Rust-tagged samples (MalwareBazaar, 2026-07) finds the same boundary at population scale: 301 are Windows PE, 28 are ELF, 12 are unclassifiable; of the 28 ELF, 10 yield author attribution at all and 4 yield enough to build a rule from. The small n is the size of the addressable population, not a sampling choice.
