...
Generated 2026-07-10T09:08:35Z.
Filter corpus A = 39 files; held-out measurement corpus B = 36 files (disjoint).
...
|---|---|---|---|---|---|
| krusty_x | ok | 0 | not earned | — | 8.3% |
| akira_v2_x | ok | 0 | ok | 0 | 8.3% |
| blackcat_sphynx_x | ok | 0 | not earned | — | 8.3% |
...
- "95% upper bound" uses the rule of three (3/n) for 0 observed FPs; it is the
  honest interval a held-out 0/36 implies, not a claim of exactly zero.
