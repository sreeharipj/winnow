# Phase 3 — Tier 1 flagship attempt (filter corpus = held-out split A, 78 files)

Generated 2026-07-10T19:36:03Z. Rules are built against Corpus A only;
...
tier1 — candidate behavioral string "{prefix:.bold.dim} {spinner} {wide_msg}" appears in the benign corpus, dropping it (not rare)
...
wrote /home/user/Videos/winnow/rules/akira_v2_x_tier1.yar (TIER 1 EARNED — 3 masked-code atoms, 22 independent behavioral strings)
```
